...
1. [Nuxt](https://nuxt.com) - The Nuxt website
2. [Nuxt Image](https://image.nuxt.com) - The documentation of `@nuxt/image`
3. [Nuxt UI](https://ui.nuxt.com) - The documentation of `@nuxt/ui` and `@nuxt/ui-pro`

There are already many websites based on this template:

this is my :shortcut{value="hello"}
